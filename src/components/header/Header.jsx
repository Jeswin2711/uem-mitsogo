...
const FreeTrail = lazy(() => import("../common/FreeTrail"))
...
const Header = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setShowFreeTrial(window.scrollY > 900);
    };
  ...
  return (
    <>
      <header
        className={`flex w-full fixed px-24 justify-between py-6 backdrop-blur-md z-50 bg-${color} max-xl:hidden`}
      >
        <div className="flex items-center gap-8 w-3/4 text-white">
          ...
          <a className="flex items-center cursor-pointer" href="#">Why Hexnode</a>
          <a className="flex items-center cursor-pointer" href="#">Features</a>
          <a className="flex items-center cursor-pointer" href="#">Platforms</a>
          <a className="flex items-center cursor-pointer" href="#">Customers</a>
        </div>
        <FreeTrail/>
      </header>
      <header
        className={`hidden fixed max-xl:flex w-full backdrop-blur-md z-50 bg-${color} flex flex-col`}
      >
        <div className={`flex justify-between w-full items-center px-4 ${showFreeTrial ? '' : 'py-4'} max-xl:px-12 max-sm:px-4`}>
          <a
            className="flex items-center"
            aria-label="Hexnode"
            href="https://www.hexnode.com/"
        ...
        <div className={`p-2 justify-end items-end  bg-white ${showFreeTrial ? 'fixed' : ''} w-full hidden max-sm:flex`}>
          <FreeTrail/>
        </div>
      </header>
      <div
      ...
      >
        ...
        <div className="flex flex-col gap-6 justify-center items-center w-3/4 m-auto py-8">
          <FreeTrail/>
          <a className="text-md" href="#">Login</a>
        </div>
      </div>
    </>
  );
