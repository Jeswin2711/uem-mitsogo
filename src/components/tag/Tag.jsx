...
const Tag = ({
  ...
  return (
    <div className={classNames(`rounded-full px-2 py-2 flex gap-2 items-center w-fit pr-4 group overflow-hidden hover:shadow-2xl hover:shadow-red-200 max-sm:px-2 max-sm:py-0`,className)}>
        <i className={`fi fi-ss-check-circle flex items-center text-2xl group-hover:hidden max-sm:text-sm`}></i>
        <i className={`fi fi-ss-check-circle hidden items-center text-2xl group-hover:flex ${color} z-10 max-sm:text-sm`}></i>
